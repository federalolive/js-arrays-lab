...
/*
Exercise 2:
  - Add the strings 'pizza' & 'cheeseburger' to the foods array such that 'pizza' 
  comes before 'cheeseburger'.
*/
...
/*
Exercise 4:
  - Access the string 'pizza' (based upon its known position) in the foods 
  array and assign it to a variable named favFood.
*/

// Complete Exercise 4 below...


// assigned pizza to new var favFood
let favFood = foods[1];
console.log(foods)
...
// assigned tofo to new index soyIdx - somehow did it relatively easily - not gloating, just proud!
